...
public class UFOEnemyShipBuilding extends EnemyShipBuilding {
	...
	@Override
	protected EnemyShip makeEnemyShip(String typeOfShip) {EnemyShip theEnemyShip = null;
	        ...
	        if(typeOfShip.equals("UFO")){
	        	EnemyShipFactory shipPartsFactory = (EnemyShipFactory) new UFOEnemyShipFactory();
